...
//     currentTLList = youthList
//         .where((element) =>
//             element.isTL && element.rollno!.substring(0, 2) == _selectedCode)
//         .toList();
//
//     print("Milgaya");
//   }
...
//     SystemChannels.textInput.invokeMethod('TextInput.hide');
//     referenceName.text = widget.model.getInTeamRef()!;
//     _selectedCode = widget.model.getRefTeam()?.substring(0, 2);
//     selectedMandal = widget.model.getRefGrp();
//     selectedTLCode = widget.model.getTlCode();
//     getCurrentTlList();
//     selectedObj =
//         currentTLList.firstWhere((element) => element.rollno == selectedTLCode);
//     selectedTL = selectedObj.rollno.toString() +
//         " " +
//         selectedObj.youthFullName.toString();
//
//     super.initState();
//     // referenceName.text = widget.model.getInTeamRef()!;
//     // selectedMandal = widget.model.getRefGrp();
...
//         //           selectedMandal = newValue!;
//         //           _selectedCode = codeMap[selectedMandal]!;
//         //           widget.model.setRefGrp(selectedMandal);
//         //           currentTLList = youthList
//         //               .where((element) =>
//         //                   element.isTL &&
//         //                   element.rollno.toString().substring(0, 2) ==
//         //                       _selectedCode)
//         //               .toList();
//         //           selectedObj = currentTLList[0];
//         //           selectedTLCode = selectedObj.rollno.toString();
//         //           selectedTL = selectedObj.rollno.toString() +
//         //               " " +
//         //               selectedObj.youthFullName.toString();
//         //           widget.model.setRefTeam(currentTLList[0].team);
//         //           widget.model.setTlCode(currentTLList[0].rollno);
//         //         });
//         //       },
//         //       value: selectedMandal,
//         //     ),
...
//   //             }).toList(),
//   //             onChanged: (Youth? newValue) {
//   //               selectedObj = newValue as Youth;
//   //               setState(() {
//   //                 selectedTLCode = newValue.rollno.toString();
//   //                 selectedTL = newValue.rollno ??
//   //                     "" + " " + newValue.youthFullName.toString();
//   //
//   //                 widget.model.setTlCode(selectedTLCode);
//   //                 Timer(Duration(seconds: 1), () {
//   //                   widget.next();
//   //                 });
//   //               });
